...
var standaloneTemplates = []journeyTemplate{
	{
		ID: "fundamentals", Split: "development",
	...
	{
		ID: "cash-quality", Split: "development",
	...
	{
		ID: "accounting-integrity", Split: "development",
	...
	{
		ID: "risk-monitoring", Split: "development",
	...
	{
		ID: "business-model", Split: "sealed_holdout",
	...
	{
		ID: "valuation-macro", Split: "sealed_holdout",
...
func ValidateStandaloneJourneySuite(suite StandaloneJourneySuite, expectedCases int) error {
	if suite.SchemaVersion != StandaloneJourneySuiteSchemaV1 || suite.UniverseID != UniverseID ||
		...
		suite.ClaimBoundary == "" || len(suite.Cases) != expectedCases {
